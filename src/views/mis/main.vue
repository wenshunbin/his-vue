...
const loading = ref(false); // 默认不显示 loading 状态
//用于获取路由参数
...
const siteContent = reactive({
	documentClientHeight: 0,  // 文档客户端高度
	siteContentViewHeight: {},  // 站点内容视图高度
	height: null,  // 高度
	mainTabs: [] as TabItem[],  // 主标签页数组
	mainTabsActiveName: '',  // 当前激活的主标签页名称
	menuActiveName: ''  // 当前激活的菜单项名称
});
...
// 定义 updatePassword 方法
function updatePassword() {
	ElMessage.info('修改密码功能尚未实现');
}
